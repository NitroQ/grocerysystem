...
public class POS {
   ...
   private DefaultTableModel model = new DefaultTableModel(data, columns) {
     ...
     private JLabel txtView_ProdName;
     private JLabel txtView_ProdName_1;
	...
	private void initialize() {
        ...
        txtView_ProdName = new JLabel("Datu Puti Vinegar 100ml");
        txtView_ProdName.setForeground(Color.WHITE);
        txtView_ProdName.setFont(new Font("Segoe UI Variable", Font.PLAIN, 20));
        txtView_ProdName.setBounds(20, 23, 285, 27);
        PaymentDetails_1.add(txtView_ProdName);
        
        txtView_ProdName_1 = new JLabel("100.00");
        txtView_ProdName_1.setForeground(Color.WHITE);
        txtView_ProdName_1.setFont(new Font("Segoe UI Variable", Font.BOLD, 59));
        txtView_ProdName_1.setBounds(20, 50, 285, 75);
        PaymentDetails_1.add(txtView_ProdName_1);
        ...
        GoShopperAdmin_Logo = new JLabel("New label");
        GoShopperAdmin_Logo.setIcon(new ImageIcon(POS.class.getResource("/GoShopper_POSAssets/LogoAdmin.png")));
        GoShopperAdmin_Logo.setBounds(0, 0, 1006, 685);
        frame.getContentPane().add(GoShopperAdmin_Logo);
        
        GoShopper_BG = new JLabel("New label");
        GoShopper_BG.setIcon(new ImageIcon(POS.class.getResource("/GoShopper_POSAssets/BGAdmin.png")));
